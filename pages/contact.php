...
<main class="content">
	<div class="subTitle">Contact pagina</div>
	<div class='contentBlockContactPage'>
		<div class='contentBlock-side'></div>
		<div class='contentBlock-content'>
			<div class='contentBlock-title'>Neem Contact op</div>
			<div class='contentBlock-text'>
				<form class="myForm" id="contactForm" method="post">
					<input type="name" id="fname" name="fname" placeholder="Voor naam" require/><br>
					<input type="name" id="lname" name="lname" placeholder="Achter naam" require/><br>
					<input type="email" id="email" name="email" placeholder="Emailadress" require/><br>
					<textarea id="subject" name="message" placeholder="Type hier uw bericht" rows="4" cols="50" require></textarea><br>
	...
	<div class="contactInfo">
		<p> Telefoonnummer: <a href="tel:0612312312">0612312312</a></p> 
